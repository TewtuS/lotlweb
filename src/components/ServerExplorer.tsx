...
const ServerModel3D = dynamic(
  () => import("./ServerModel3D").then((mod) => mod.ServerModel3D),
  {
    ssr: false,
    loading: () => (
      <div className="flex h-full items-center justify-center rounded-[1.75rem] bg-[#0a0a0a]">
...
export function ServerExplorer() {
  ...
  return (
    <section className="feature-bg relative px-6 py-10 md:px-10 md:py-14 lg:px-16">
      <div className="relative mx-auto max-w-6xl">
        <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-12 md:gap-6">
          <div className="relative md:col-span-7">
            <div className="relative mx-auto aspect-[4/5] w-full max-w-md overflow-hidden rounded-[1.75rem] bg-[#0a0a0a] shadow-2xl md:mx-0 md:aspect-auto md:h-[440px] md:max-w-none">
              <ServerModel3D
                parts={serverParts}
